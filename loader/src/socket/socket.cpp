...
modification::loader::socket::socket(const std::string& ip, const std::string& port,
                                     const std::string& encryption_key)
    : encryption_key_{encryption_key} {
  VMProtectBeginUltra("modification::loader::socket::socket()");
...
modification::loader::socket::~socket() {
  VMProtectBeginUltra("modification::loader::socket::~socket()");
...
std::string modification::loader::socket::send(const std::string& message) {
  VMProtectBeginUltra("modification::loader::socket::send()");
